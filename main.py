...
"""
==========================================================================================================================================================================
Назва показника        | Од. виміру | Підприємство  | Базовий рік | Поперед. рік | Поточ. рік | Абсолют. відхил.(+) | Відхил.(+) в % | Абсолют. відхил(-) | Відхил(-) в % 
==========================================================================================================================================================================
"""
...
def show_analiz_table(index_list):
    ...
    for index in index_list:
        print(f"{index['index_name']:24}",
              ...
              f"{index['pre_year']:>14}",
              f"{index['curr_year']:>13}",
              f"{index['deviation +']:>16.2f}",
              f"{index['+ in percent']:>18.2f}",
              f"{index['deviation -']:>18.2f}",
              f"{index['- in percent']:>18.2f}"
              )
    print(FOOTER)
